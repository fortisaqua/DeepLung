config = {'train_data_path':['/opt/LUNA16/subset0/',
          ...
          'train_preprocess_result_path':'/opt/LUNAPreprocess/', # contains numpy for the data and label, which is generated by prepare.py
          'val_preprocess_result_path':'/opt/LUNAPreprocess/',  # make sure copy all the numpy into one folder after prepare.py
